...
**Primary audience**:
People seeking founding engineers or product engineers who care about product thinking, design, UI, UX, and code. Fellow builders are also an important audience.
...
**Living area**:
The parts of the site that can grow through notes, experiments, cultural entries, or discoveries without a publishing schedule.
_Avoid_: Blog, feed
