...
function fallbackSignal(): HistorySignal {
  return {
    ...
    description: "I couldn’t get a varied live list this week, so here are three saved examples from different eras.",
...
export async function getHistorySignal(now = new Date()): Promise<HistorySignal> {
  ...
  try {
    ...
    return {
      ...
      description: "I pull this list from Wikimedia, then cache it for up to seven days.",
