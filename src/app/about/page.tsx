    ...
    <div className="collection-page about-page">
      ...
      <main id="main-content">
        ...
        <section className="about-contact" id="contact" aria-labelledby="about-contact-title">
          ...
          <a href={profile.links.email}>Start a conversation <span className="arrow-mark" aria-hidden="true">↗︎</span></a>
          <div>
            <span>eliasthebennett@gmail.com</span>
            <a href={profile.links.github} target="_blank" rel="noreferrer">GitHub <span className="arrow-mark" aria-hidden="true">↗︎</span></a>
            {profile.links.resume && <a href={profile.links.resume} target="_blank" rel="noreferrer">Résumé <span className="arrow-mark" aria-hidden="true">↗︎</span></a>}
          </div>
        </section>
      </main>
    </div>
